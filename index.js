...
var APIKey = hexo.config.flickr_ext_api_key || false;
...
// option
var cacheFilePath = hexo.config.flickr_ext_cache_file_path || false;
var cachePeriod   = hexo.config.flickr_ext_cache_expires || false;
...
function filterElement(flJson){
  ...
  // test add
  returnJson.photo.originalsecret        = flJson.photo.originalsecret || null;
  returnJson.photo.originalformat        = flJson.photo.originalformat || null;
  ...
  var tag = tagUtil.convertAttr(tagArgs);
    ...
    return new Promise(function (resolve, reject) {
      ...
      if(!flJson){
        ...
        https.get(option_obj, function (res) {
          var data = '';
 ...
 * ```
 */
hexo.extend.tag.register('flickrExt', function (args, content) {
